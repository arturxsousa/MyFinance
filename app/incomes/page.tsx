...
const TYPES = ["Salary", "Freelance", "Investment", "Rental", "Other"];

const typeBadgeColor: Record<string, string> = {
  Salary:     "bg-emerald-900 text-emerald-300",
  Freelance:  "bg-violet-900 text-violet-300",
  Investment: "bg-blue-900 text-blue-300",
  Rental:     "bg-orange-900 text-orange-300",
  Other:      "bg-gray-700 text-gray-300",
};

const empty = { source: "", type: "Salary", amount: "", date: "" };
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-800 text-gray-400 uppercase text-xs tracking-wider">
              <th className="text-left px-6 py-4">Income Source</th>
            ...
            {incomes.map((income) => (
              ...
              >
                ...
                <td className="px-6 py-4">
                  <span className={`px-2 py-1 rounded-md text-xs font-medium ${typeBadgeColor[income.type] ?? typeBadgeColor.Other}`}>
                    {income.type}
                  </span>
                </td>
                ...
                <td className="px-6 py-4 text-right text-gray-400">{income.date}</td>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
          <div className="bg-gray-900 rounded-xl p-6 w-full max-w-md shadow-xl">
            <h2 className="text-lg font-semibold text-white mb-6">Add Income</h2>
            <div className="flex flex-col gap-4">
              <div>
                <label className="text-xs text-gray-400 mb-1 block">Income Source</label>
                <input
                  type="text"
